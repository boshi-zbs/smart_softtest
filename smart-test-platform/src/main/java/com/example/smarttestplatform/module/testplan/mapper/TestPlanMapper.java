...
public interface TestPlanMapper {
    ...
    @Insert("INSERT INTO test_plan(project_id, plan_name, description, start_date, end_date, status, creator_id) " +
            "VALUES(#{projectId}, #{planName}, #{description}, #{startDate}, #{endDate}, #{status}, #{creatorId})")
